...
#ifndef __Pool_mul_32s_16nsjbC__HH__
#define __Pool_mul_32s_16nsjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mul_32s_16nsjbC) {
    ...
    SC_CTOR(Pool_mul_32s_16nsjbC):  ACMP_mul_su_U ("ACMP_mul_su_U") {
