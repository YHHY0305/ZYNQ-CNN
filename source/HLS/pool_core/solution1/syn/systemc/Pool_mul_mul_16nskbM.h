...
#ifndef __Pool_mul_mul_16nskbM__HH__
#define __Pool_mul_mul_16nskbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mul_mul_16nskbM) {
    ...
    SC_CTOR(Pool_mul_mul_16nskbM):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
