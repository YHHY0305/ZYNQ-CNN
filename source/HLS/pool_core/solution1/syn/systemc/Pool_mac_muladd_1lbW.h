...
#ifndef __Pool_mac_muladd_1lbW__HH__
#define __Pool_mac_muladd_1lbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mac_muladd_1lbW) {
    ...
    SC_CTOR(Pool_mac_muladd_1lbW):  simcore_mac_0_U ("simcore_mac_0_U") {
