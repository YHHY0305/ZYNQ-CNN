...
#ifndef __Pool_dadddsub_64nfYi__HH__
#define __Pool_dadddsub_64nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_dadddsub_64nfYi) {
    ...
    SC_CTOR(Pool_dadddsub_64nfYi):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
