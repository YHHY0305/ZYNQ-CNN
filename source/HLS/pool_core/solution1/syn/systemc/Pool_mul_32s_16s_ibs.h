...
#ifndef __Pool_mul_32s_16s_ibs__HH__
#define __Pool_mul_32s_16s_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(Pool_mul_32s_16s_ibs) {
    ...
    SC_CTOR(Pool_mul_32s_16s_ibs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
