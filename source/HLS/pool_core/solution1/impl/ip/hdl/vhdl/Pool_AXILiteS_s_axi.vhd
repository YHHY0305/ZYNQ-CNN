...
architecture behave of Pool_AXILiteS_s_axi is
    ...
    constant ADDR_SX_V_DATA_0        : INTEGER := 16#38#;
    constant ADDR_SX_V_CTRL          : INTEGER := 16#3c#;
    constant ADDR_SY_V_DATA_0        : INTEGER := 16#40#;
    constant ADDR_SY_V_CTRL          : INTEGER := 16#44#;
    constant ADDR_MODE_V_DATA_0      : INTEGER := 16#48#;
    constant ADDR_MODE_V_CTRL        : INTEGER := 16#4c#;
    constant ADDR_FEATURE_IN_DATA_0  : INTEGER := 16#50#;
    constant ADDR_FEATURE_IN_CTRL    : INTEGER := 16#54#;
    constant ADDR_FEATURE_OUT_DATA_0 : INTEGER := 16#58#;
    constant ADDR_FEATURE_OUT_CTRL   : INTEGER := 16#5c#;
