...
void XPool_Set_Sx_V(XPool *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XPool_WriteReg(InstancePtr->Axilites_BaseAddress, XPOOL_AXILITES_ADDR_SX_V_DATA, Data);
}

u32 XPool_Get_Sx_V(XPool *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XPool_ReadReg(InstancePtr->Axilites_BaseAddress, XPOOL_AXILITES_ADDR_SX_V_DATA);
    return Data;
}

void XPool_Set_Sy_V(XPool *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XPool_WriteReg(InstancePtr->Axilites_BaseAddress, XPOOL_AXILITES_ADDR_SY_V_DATA, Data);
}

u32 XPool_Get_Sy_V(XPool *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XPool_ReadReg(InstancePtr->Axilites_BaseAddress, XPOOL_AXILITES_ADDR_SY_V_DATA);
    return Data;
}
